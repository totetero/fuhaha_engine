...
// 構造体実体
struct engineLayoutPartsSwipeScrollerImplement{
	struct engineLayoutPartsSwipeScroller super;
...
// 初期化
static void init(struct engineLayoutPartsSwipeScrollerImplement *this){
	...
	engineLayoutViewGearFamilyAdd((struct engineLayoutView*)this, (struct engineLayoutView*)this->super.viewBarX);
	engineLayoutViewGearFamilyAdd((struct engineLayoutView*)this, (struct engineLayoutView*)this->super.viewBarY);
	engineLayoutViewGearGraphicObjectConnect((struct engineLayoutView*)this, (struct engineLayoutView*)this->super.viewInner);
	engineLayoutViewGearGraphicObjectConnect((struct engineLayoutView*)this, (struct engineLayoutView*)this->super.viewBarX);
	engineLayoutViewGearGraphicObjectConnect((struct engineLayoutView*)this, (struct engineLayoutView*)this->super.viewBarY);
}

// ----------------------------------------------------------------

// タッチ処理
static bool touch(struct engineLayoutPartsSwipeScrollerImplement *this, int touchIndex, double x, double y, bool dn, bool mv, bool isCancel){
	return engineLayoutUtilSwipeTouch(&this->super.swipe, (struct engineLayoutView*)this, touchIndex, x, y, dn, mv, isCancel);
}

// 計算
static void calc(struct engineLayoutPartsSwipeScrollerImplement *this, bool isCancel){
	// 大きさ取得
	...
	double outerH = engineLayoutViewGearPositionGetH((struct engineLayoutView*)this);
	...
	// 位置設定
	engineLayoutViewGearPositionSetLtTpWtHt((struct engineLayoutView*)this->super.viewInner, this->super.position.x, this->super.position.y, innerW, innerH);
	engineLayoutViewGearPositionSetLtTpWtHt((struct engineLayoutView*)this->super.viewBarX, barX, 0, barW, outerH);
	engineLayoutViewGearPositionSetLtTpWtHt((struct engineLayoutView*)this->super.viewBarY, 0, barY, outerW, barH);
...
struct engineLayoutPartsSwipeScroller *engineLayoutPartsSwipeScrollerCreate(void){
	...
	return (struct engineLayoutPartsSwipeScroller*)this;
}
