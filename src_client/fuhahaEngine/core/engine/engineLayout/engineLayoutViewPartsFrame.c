...
// 構造体実体
struct engineLayoutViewPartsFrameImplement{
	struct engineLayoutViewPartsFrame super;

	struct engineLayoutViewPartsFrameBufferCompare{
...
// タッチ処理
static bool touch(struct engineLayoutViewPartsFrameImplement *this, int touchIndex, double x, double y, bool dn, bool mv, bool isCancel){
	bool isActive = false;
...
// 計算
static void calc(struct engineLayoutViewPartsFrameImplement *this, bool isCancel){
	// 子要素計算
...
// 一時停止
static void pause(struct engineLayoutViewPartsFrameImplement *this){
	// 子要素一時停止
	engineLayoutViewUtilChildrenPause((struct engineLayoutView*)this);
}

// 破棄
static void dispose(struct engineLayoutViewPartsFrameImplement *this){
	// 子要素破棄
...
struct engineLayoutViewPartsFrame *engineLayoutViewPartsFrameCreate(){
	struct engineLayoutViewPartsFrameImplement *this = (struct engineLayoutViewPartsFrameImplement*)engineUtilMemoryInfoCalloc("engineLayoutViewPartsFrame", 1, sizeof(struct engineLayoutViewPartsFrameImplement));
	init(this);
	...
	return (struct engineLayoutViewPartsFrame*)this;
}
