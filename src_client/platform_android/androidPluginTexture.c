...
// テクスチャのコールバック
JNIEXPORT void JNICALL Java_com_totetero_fuhaha_AndroidPluginTexture_gamePluginTextureLocalCallback(JNIEnv *env, jobject obj, jint callbackId, jint glId, jint w, jint h){
