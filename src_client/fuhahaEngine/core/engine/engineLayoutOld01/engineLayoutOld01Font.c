...
static void draw(struct engineLayoutOld01Trans *that, struct engineMathMatrix44 *mat, struct engineMathVector4 *color){
	struct engineLayoutOld01Font *this = (struct engineLayoutOld01Font*)((char*)that - offsetof(struct engineLayoutOld01Font, trans));
	engineLayoutOld01FontDraw(this, mat, color);
}

// 破棄
static void dispose(struct engineLayoutOld01Trans *that){
	struct engineLayoutOld01Font *this = (struct engineLayoutOld01Font*)((char*)that - offsetof(struct engineLayoutOld01Font, trans));
	engineLayoutOld01FontDispose(this);
}
...
// バッファ作成
static void createBuffer(struct engineLayoutOld01Font *this){
...
void engineLayoutOld01FontDraw(struct engineLayoutOld01Font *this, struct engineMathMatrix44 *mat, struct engineMathVector4 *color){
	...
	for(int i = 0; i < this->fontInfo.codeListLength; i++){
		...
		if(tagColor != codeData->tag.color){
			...
			engineLayoutOld01TransBindColor(&this->trans, &newColor);
		}
...
void engineLayoutOld01FontDispose(struct engineLayoutOld01Font *this){
	engineLayoutOld01FontSet(this, -1, NULL);
}
