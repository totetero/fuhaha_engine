...
static void draw(struct engineLayoutOld01Trans *that, struct engineMathMatrix44 *mat, struct engineMathVector4 *color){
	struct engineLayoutOld01ImageFrame *this = (struct engineLayoutOld01ImageFrame*)((char*)that - offsetof(struct engineLayoutOld01ImageFrame, trans));
	engineLayoutOld01ImageFrameDraw(this, mat, color);
}

// 破棄
static void dispose(struct engineLayoutOld01Trans *that){
	struct engineLayoutOld01ImageFrame *this = (struct engineLayoutOld01ImageFrame*)((char*)that - offsetof(struct engineLayoutOld01ImageFrame, trans));
	engineLayoutOld01ImageFrameDispose(this);
}
